...
class AddSeriesMatchesPage extends StatefulWidget {
  const AddSeriesMatchesPage(
      {String? seriesName,
      String? totalMatches,
      String? seriesType,
      String? startDate,
  ...
  @override
  State<AddSeriesMatchesPage> createState() => _AddSeriesMatchesPageState();
}

class _AddSeriesMatchesPageState extends State<AddSeriesMatchesPage> {
  //All my controllers..........................................................
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                            ...
                            onPressed: () {
                              matchScreenService.postPlayerDataTeam1(
                                  selectedTeam1,
                                  selectedTeam2,
                                  currentMatchNumber,
                                  selectedPlayers1);
                              matchScreenService.postPlayerDataTeam2(
                                  selectedTeam1,
                                  selectedTeam2,
                                  currentMatchNumber,
                                  selectedPlayers2);
                              ...
                              testId.sort();
                              String mainId = '${testId[0]}_${testId[1]}';
                              print(mainId);

                              String matchId =
                                  'match_${currentMatchNumber}_$mainId';
                              print(matchId);
                            ...
                            child: Text("Squad Selection Completed"))
                      ])
                ])));
  }
}
